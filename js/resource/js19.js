...
const imports = document.querySelector('impotants');

// HTMLCollection 타입은 Array가 아니므로 편리한 배열 함수들(forEach, filter, ...)을 
// 이용할 수 없다
console.log(listItems);
console.log(importants);

// name 속성으로 선택하는 경우 NodeList 타입으로 꺼내는 forEach만 구현괴어 있다
console.log(datas);
console.log(head2);
console.log(imports);
...
test1.setAttribute('style', 'boder: solid 1px black'); 
